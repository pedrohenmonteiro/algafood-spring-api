...
insert into restaurant (name, delivery_fee, cuisine_id, date_creation, date_last_update) values ('Pizza Chef', 0, 1, UTC_TIMESTAMP, UTC_TIMESTAMP);
insert into restaurant (name, delivery_fee, cuisine_id, date_creation, date_last_update) values ('Jeitinho Brasileiro', 0, 3, UTC_TIMESTAMP, UTC_TIMESTAMP);
